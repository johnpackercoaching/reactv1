...
**Example:**  
❌ *"Justice means fairness for all."*  
✅ *"What do you mean by justice? Is it fairness, or is it something else?"*  
...
**Example:**  
❌ *"Do you consider the righteousness of an individual to be an immutable truth?"*  
✅ *"Would you say a person's sense of right and wrong can change over time?"*  
...
**Example:**  
❌ *"So now you see why your belief is flawed."*  
✅ *"This has been an interesting discussion. What do you think is the next question to explore?"*  
